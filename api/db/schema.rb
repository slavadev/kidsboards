...
ActiveRecord::Schema.define(version: 20160202185421) do
  ...
  create_table "actions", force: :cascade do |t|
    ...
    t.index ["adult_id"], name: "index_actions_on_adult_id", using: :btree
    t.index ["goal_id"], name: "index_actions_on_goal_id", using: :btree
    t.index ["id"], name: "index_actions_on_id", using: :btree
  ...
  create_table "adults", force: :cascade do |t|
    ...
    t.index ["id"], name: "index_adults_on_id", using: :btree
  ...
  create_table "children", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["id"], name: "index_children_on_id", using: :btree
  ...
  create_table "families", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["id"], name: "index_families_on_id", using: :btree
  ...
  create_table "goals", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["child_id"], name: "index_goals_on_child_id", using: :btree
    t.index ["id"], name: "index_goals_on_id", using: :btree
