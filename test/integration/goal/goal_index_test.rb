...
class Family::GoalIndexTest < ActionDispatch::IntegrationTest
  test 'goal index success' do
    ...
    delete "/api/v1/goal/#{goals[2][:id]}", token: token

    # action
    get "/api/v1/family/child/#{child_id}/goal", token: token
  ...
  test 'goal index with filters success' do
    ...
    diff = goals[2][:target]
    patch "/api/v1/goal/#{goals[2][:id]}/points", token: token, adult_id: adult_id, diff: diff
    ...
    # action 2
    get "/api/v1/family/child/#{child_id}/goal", token: token, completed: false
    ...
    # action 2
    get "/api/v1/family/child/#{child_id}/goal", token: token, completed: true
  ...
  test 'goal index wrong params' do
    ...
    # action 2
    get '/api/v1/family/child/goal', token: token
  ...
  test 'goal index without token' do
    ...
    # action 1
    get "/api/v1/family/child/#{child_id}/goal"
